...
import {
  View, StyleSheet, ScrollView, TouchableOpacity, Text, Modal,
  TouchableHighlight
} from 'react-native';
import moment from "moment";
import { DatePicker, List, PickerView, Picker, Button, ActionSheet, } from 'antd-mobile';
const now = new Date();
...
export default class diffDataCalendar extends React.Component {
  ...
  funcustomConfirm() {
    var options = {
      title: '购买', /*不显示头部标题*/
      headStyle: {
        backgroundColor: '#ffffff', color: '#333333', fontSize: 24,
        paddingTop: 10,
      },
    ...
    return (
      <ScrollView style={styles.container}>
        ...
        <TouchableHighlight style={[styles.comBtnBtnView, { width: 100 }]} underlayColor='transparent'
         onPress={
          //  this.funcustomConfirm.bind(this)
